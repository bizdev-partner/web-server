...
export interface ILeadService {
     ...
     */
    createLead(command: Contracts.CreateLeadCommand): Promise<Lead>;
     ...
     */
    updateLead(command: Contracts.UpdateLeadCommand): Promise<Lead>;
     ...
     * @returns The updated lead.
     */
    updateLeadStatus(command: Contracts.UpdateLeadStatusCommand): Promise<Lead>;
     ...
     */
    getLeadDetails(query: Contracts.GetLeadDetailsQuery): Promise<Lead>;
     ...
     */
    listLeads(query: Contracts.ListLeadsQuery): Promise<Lead[]>;
}
